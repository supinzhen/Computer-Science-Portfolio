...
hparams = {'num_outputs':1, 'num_hiddens_1':2048, 'num_hiddens_2':2048, 
           ...
           'dropout_1':0.0, 'dropout_2':0.0, 'dropout_3':0.0,'dropout_4':0.0, 'dropout_5':0.0, 'lr':0.01}
...
print("Saved PyTorch Model State to mlpv.params")
...
submission.to_csv('submissionm0.csv', index=False)